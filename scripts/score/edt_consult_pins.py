...
**Provenance of the pins.** The consult measured the first set on a
fluid-closure arm's run, over 0.1-20.1 ms at a mean loop current of 2772 A.
That run's artifact is RETIRED, so every pin below is
...
#: Q2 -- the cathode-face pins of the amendment, measured on the RETIRED
#: fluid-closure arm's run and reported by the Q2
