...
def read_adf15(path):
    ...
    convention the interpolator below shares with ``cablp.funcs._adas``.
...
def pec_at(block, ne_cm3, Te_eV):
    ...
    edges. The arithmetic deliberately mirrors ``cablp.funcs._adas`` so the
...
def main():
    ...
    out = [
        ...
        "",
        "Regenerated by `scripts/pec_band_fractions.py` from the OPEN-ADAS "
        ...
        "interpolators in `cablp/funcs/_adas.py`. Do not edit by hand.",
        "",
    ]
