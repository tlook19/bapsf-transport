...
2026-09-03). `default_config()` is the template of keys and their classes, not a
plasma anyone runs; `stances/g1atrim.toml` is the LAPD reference configuration a
run starts from; and an alternate the campaign runs against it is a DERIVED
