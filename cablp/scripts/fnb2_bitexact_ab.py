...
This extends the pass-1 fnb1_bitexact_ab.py pattern with the one key pass 2
registers. If the two arms agree at the bit, the pass-2 build is inert with the
flag off, which is the whole claim the golden then confirms on the production
configuration.
